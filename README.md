...
- **[CRE Cron Trigger](https://github.com/nhx-finance/bridge/blob/main/kesy-bridge/kesy-bridge-workflow/main.ts)** — Automated compliance sync between Hedera and Sepolia.
- **[Tenderly AI Simulation Agent](https://github.com/nhx-finance/bridge/blob/main/kesy-bridge/agentic-bridging-workflow/main.ts)** — Hyper-realistic transaction simulation with agentic analysis.
